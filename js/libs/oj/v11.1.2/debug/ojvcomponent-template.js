...
define(['exports', 'ojs/ojlogger', 'ojs/ojhtmlutils', 'ojs/ojcspexpressionevaluator', 'ojs/ojcustomelement-utils', 'preact', 'ojs/ojcontext', 'ojs/ojdataproviderhandler', 'ojs/ojbindpropagation'], function (exports, Logger, HtmlUtils, CspExpressionEvaluator, ojcustomelementUtils, preact, Context, ojdataproviderhandler, ojbindpropagation) { 'use strict';
    ...
    class BindDom extends preact.Component {
        ...
        render() {
            return (preact.h(preact.Fragment, null, this.state.view && this.state.data && this.props.executeFragment
